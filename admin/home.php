<h1 class="">Welcome to Longping Tropical Rice Development Inc.</h1>
<hr>
<div class="row">
    <div class="col-12 col-sm-6 col-md-3">
        <div class="info-box bg-light shadow">
            ...
            <span class="info-box-number text-right">
                <?php 
                    echo $conn->query("SELECT * FROM `stock_in_list`")->num_rows;
                ?>
            </span>
            </div>
            <!-- /.info-box-content -->
    ...
    <div class="col-12 col-sm-6 col-md-3">
        <div class="info-box bg-light shadow">
            ...
            <span class="info-box-number text-right">
                <?php 
                    echo $conn->query("SELECT * FROM `warehouse_list` where `status` = 1")->num_rows;
                ?>
            </span>
            </div>
            <!-- /.info-box-content -->
