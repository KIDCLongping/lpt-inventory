<?php 
$qry = $conn->query("SELECT b.*,s.name as warehouse,p.po_code FROM back_order_list b inner join warehouse_list s on b.warehouse_id = s.id inner join stock_in_list p on b.po_id = p.id  where b.id = '{$_GET['id']}'");
if($qry->num_rows >0){
        ...
        <div class="container-fluid">
            ...
            <table class="table table-striped table-bordered" id="list">
                ...
                <tbody>
                    <?php 
                    $total = 0;
                    $qry = $conn->query("SELECT b.*,i.name,i.classification FROM `bo_items` b inner join item_list i on b.item_id = i.id where b.bo_id = '{$id}'");
