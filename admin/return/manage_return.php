<?php 
if(isset($_GET['id'])){
    $qry = $conn->query("SELECT r.*,s.name as warehouse FROM return_list r inner join warehouse_list s on r.warehouse_id = s.id  where r.id = '{$_GET['id']}'");
    if($qry->num_rows >0){
            ...
            <div class="container-fluid">
                    ...
                    <div class="row justify-content-center align-items-end">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control rounded-0" id="packaging_size">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                ...
                <table class="table table-striped table-bordered" id="list">
                    ...
                    <tbody>
                        ...
                        $total = 0;
                        if(isset($id)):
                        $qry = $conn->query("SELECT s.*,i.name,i.classification FROM `stock_list` s inner join item_list i on s.item_id = i.id where s.id in ({$stock_ids})");
...
<table id="clone_list" class="d-none">
    <tr>
        ...
        <td class="py-1 px-2 text-center qty">
            ...
            <input type="hidden" name="packaging_size[]">
...
<script>
    ...
    $(function(){
        ...
        $('#add_to_list').click(function(){
            ...
            var item_name = items[warehouse][item].name || 'N/A';
            var item_classification = items[warehouse][item].classification || 'N/A';
            var tr = $('#clone_list tr').clone()
            if(item == '' || qty == '' || packaging_size == '' ){
            ...
            tr.find('.item').html(item_name+'<br/>'+item_classification)
