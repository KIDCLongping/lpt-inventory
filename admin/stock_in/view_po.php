...
<div class="card card-outline card-primary">
            ...
            <table class="table table-striped table-bordered" id="list">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <class="py-1 px-2 text-center"><?php echo ($row['packaging_size']) ?></ 
                        <td class="py-1 px-2">
    ...
    <div class="card-footer py-1 text-center">
        ...
        <a class="btn btn-flat btn-primary" href="<?php echo base_url.'/admin?page=stock_in/manage_po&id='.(isset($id) ? $id : '') ?>">Edit</a>
        <a class="btn btn-flat btn-dark" href="<?php echo base_url.'/admin?page=stock_in' ?>">Back To List</a>
    </div>
</div>
