...
class SystemSettings extends DBConnection
{
	...
	function update_settings_info(){
        ...
        // Your existing code for updating settings
        // ...
        ...
        if (isset($_FILES['img']) && $_FILES['img']['tmp_name'] != '') {
            ...
            if (in_array($type, $allowed)) {
                move_uploaded_file($_FILES['img']['tmp_name'], $dir_path);
        ...
        if (isset($_FILES['cover']) && $_FILES['cover']['tmp_name'] != '') {
            ...
            if (in_array($type, $allowed)) {
                move_uploaded_file($_FILES['cover']['tmp_name'], $dir_path);
...
// Instantiate SystemSettings and load system info
...
switch ($action) {
    case 'update_settings':
        ...
        break;
    default:
        // Handle other actions or display content
        break;
}
?>